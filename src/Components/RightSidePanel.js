	...
	return (
		<div className="filters-sidebar-inner">
			<div className="signUpArea">
				...
				<div className="hs-lead">Pay only for the hours worked</div>
				<a className="btn btn-primary btn-130" href="https://talent.hubstaff.com/signup?message=" target="">
					Sign Up
				</a>
				<a className="textInSignUp" href="/" target="">
					Learn more...
				</a>
			</div>
